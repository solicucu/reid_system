...
# @Date:   2020-02-15 10:56:49
# @Last Modified time: 2020-03-13 18:09:18
import torch
import numpy as np 
...
class Architect(object):
	...
	def __init__(self, model, args):
		...
		self.lr_scheduler = lr_scheduler.MultiStepLR(self.optimizer, [60, 150], 0.1)
	"""
	...
	def _compute_unrolled_model(self,train_input, train_label, eta, network_optimizer):
		...
		for i, value in enumerate(res):
			if value is not None:
				logger.info("{}, size:{}".format(i,value.size()))
			else:
				logger.info("{}, None".format(i))
		"""
		"""
