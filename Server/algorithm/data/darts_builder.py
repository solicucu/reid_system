...
# @Date:   2020-02-09 17:52:00
# @Last Modified time: 2020-02-16 13:29:13
import numpy as np  
import logging 
...
def make_data_loader(cfg):
	...
	dataset = init_dataset(cfg.dataset, cfg.dataset_dir)

	num_classes = dataset.num_train_pids 
	# print(num_classes) 751

	train, val = split_train_and_val(dataset.train, cfg.num_instance)
	...
	if cfg.sampler == 'triplet':
		...
		raise RuntimeError("{} not know sampler".format(cfg.sampler))
